...
//             <select
//               className="w-full md:w-auto p-2 border border-[#263138] rounded-md focus:outline-none focus:ring-2 focus:ring-[#7EC1B1]"
//               value={entries}
//               onChange={(e) => {
...
//                 className="w-full md:w-64 p-2 border border-[#263138] rounded-md focus:outline-none focus:ring-2 focus:ring-[#7EC1B1] pr-10 cursor-pointer"
//               />
//               <LuCalendar
...
//             {showDatePicker && (
//               <div className="absolute z-50 top-full left-0 mt-2 bg-white shadow-lg rounded-md p-4 flex gap-6">
//                 {/* Left side quick selects */}
...
//             <select
//               className="w-full md:w-auto p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7EC1B1]"
//               value={statusFilter}
