...
//           {/* Left Controls: Show Entries + Search */}
...
//           <table className="table-auto w-full min-w-[600px] border border-gray-[#CACACA]">
//             <thead>
//               <tr className="bg-[#F5F5F5] text-center text-sm md:text-lg">
//                 <th className="h-[50px] md:h-[80px] font-poppins font-medium text-center">Sr. No.</th>
//                 <th className="p-2 md:p-3 font-poppins font-medium text-center">Category</th>
//                 <th className="p-2 md:p-3 font-poppins font-medium text-center">Product Name</th>
//                 <th className="p-2 md:p-3 font-poppins font-medium text-center">Price</th>
//                 <th className="p-2 md:p-3 font-poppins font-medium text-center">Warranty</th>
//                 <th className="p-2 md:p-3 font-poppins font-medium text-center">Discount</th>
//                 <th className="p-2 md:p-3 font-poppins font-medium text-center">Status</th>
//                 <th className="p-2 md:p-3 font-poppins font-medium text-center">Action</th>
//               </tr>
//             </thead>
//             <tbody className="text-center text-sm md:text-base">
//               {paginatedRows.map((row) => (
//                 <tr key={row.id} className="bg-white text-black">
//                   <td className="p-2 md:p-3">{row.id}</td>
//                   <td className="p-2 md:p-3">{row.category}</td>
//                   <td>
//                     <div className="truncate max-w-[150px] md:max-w-[200px]" title={row.product}>
//                       {row.product}
//                     </div>
//                   </td>
//                   <td className="p-2 md:p-3">{row.price}</td>
//                   <td className="p-2 md:p-3">{row.warranty}</td>
//                   <td className="p-2 md:p-3">{row.discount}</td>
//                   <td>
//                     <div
//                       className={`p-1 md:p-2 ${row.status === "Approved"
//                           ? "text-[#34C759]"
//                           : row.status === "Pending"
//                             ? "text-[#FFCC00]"
//                             : "text-[#FF383C]"
...
//                     </div>
//                   </td>
//                   <td className="p-2 md:p-3 flex gap-2 justify-center flex-wrap">
...
//                 className={`p-1 md:p-2 border rounded-lg border-[#7EC1B1] ${page === idx + 1 ? "bg-[#7EC1B1] text-white" : ""
//                   } w-[30px] md:w-[36px]`}
//               >
//                 {idx + 1}
//               </button>
