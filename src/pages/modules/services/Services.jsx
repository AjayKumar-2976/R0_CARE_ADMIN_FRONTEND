...
//                     <td className="p-4 capitalize truncate max-w-[200px]">{row.serviceAMC}</td>
//                     <td className="p-4">{row.price}</td>
//                     <td className="p-4">{row.warrenty}</td>
...
//             {paginatedRows.map((row) => (
//               <div key={row.id} className="border border-gray-300 rounded-lg p-3 shadow-sm">
//                 <p><strong>Sr. No.:</strong> {row.id}</p>
//                 <p><strong>Category:</strong> {row.category}</p>
//                 <p><strong>Service & AMC Plan Name:</strong> {row.serviceAMC}</p>
//                 <p><strong>Price:</strong> {row.price}</p>
//                 <p><strong>Warrenty/Validity:</strong> {row.warrenty}</p>
