...
const AdminLayout = () => {
  ...
  <Route path="/roles-permission" element={<RolesAndPermissions />} />
    <Route path="/roles-permission/create-sub-admin" element={<AddRole/>} />
            <Route path="/roles-permission/edit-sub-admin/:id" element={<EditRole />} />
            <Route path="/roles-permission/view-sub-admin/:id" element={<ViewRole/>} />
